...
<!-- Mirrored from tunatheme.com/tf/html/vicodin-preview/vicodin/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Jul 2022 12:21:55 GMT -->
<head>
    <meta charset="utf-8">
...
<div class="body-wrapper">
    ...
    <div id="ltn__utilize-mobile-menu" class="ltn__utilize ltn__utilize-mobile-menu">
        <div class="ltn__utilize-menu-inner ltn__scrollbar">
            <div class="ltn__utilize-menu-head">
                <div class="site-logo">
                    <a href="index.html"><img src="/img/YEDDESPARAPHARMACIE.png" alt="Logo"></a>
                </div>
                <button class="ltn__utilize-close">×</button>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="ltn__breadcrumb-inner">
                        ...
                        <div class="ltn__breadcrumb-list">
                            <ul>
                                <li><a href="index.html"><span class="ltn__secondary-color"><i class="fas fa-home"></i></span> Accueil</a></li>
                                <li>Service</li>
                            </ul>
                        </div>
                    </div>
                                    ...
                                    <div class="col-xl-4 col-sm-6 col-6">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <img src="../admin/uploads/<?php echo $donnees['image'] ?>">
                                            ...
                                            <div class="product-info">
                                                <div class="product-ratting">
                                                    <ul>
                                                        <li><a href="#"><?php echo $donnees['Date'] ?></a></li>
                                                      
                                                    </ul>
                                                </div>
                                                <h2 class="product-title"><a href="product-details.html"><?php echo $donnees['Nom'] ?></a></h2>
                                                <div class="product-price">
                                                    <span><?php echo $donnees['Prix'] ?></span>
                                                    
                                                </div>
                                                <button type="button" class="btn btn-primary" ><a href="reservation.php?id=<?php echo $donnees['id'] ?>">Réserver</button>
                                            </div>
                                        </div>
                                    </div>
                                    <?php } ?>
...
<!-- Mirrored from tunatheme.com/tf/html/vicodin-preview/vicodin/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Jul 2022 12:21:57 GMT -->
</html>
